        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RojasT_Nombre = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    Edad = table.Column<int>(type: "int", nullable: false),
                    ValorRevision = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mascotas_Propietarios_PropietarioMascotaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tarifa = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
