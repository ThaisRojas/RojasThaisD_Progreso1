...
namespace RojasT_ClinicaV_P1.Controllers
{
    public class PropietarioMascotasController : Controller
    {
        private readonly ClinicaContext _context;

        public PropietarioMascotasController(ClinicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var propietarioMascota = await _context.Propietarios
        ...
        public async Task<IActionResult> Create([Bind("Id,RojasT_Nombre,Edad,ValorRevision,EsClienteFrecuente,FechaRegistro")] PropietarioMascota propietarioMascota)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var propietarioMascota = await _context.Propietarios.FindAsync(id);
            if (propietarioMascota == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RojasT_Nombre,Edad,ValorRevision,EsClienteFrecuente,FechaRegistro")] PropietarioMascota propietarioMascota)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (propietarioMascota != null)
            {
                _context.Propietarios.Remove(propietarioMascota);
            }
